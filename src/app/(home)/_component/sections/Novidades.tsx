...
import { CarouselSpacing } from '../novidades/carrosel'

export const Novidades = () => {
  return (
    <section className="to-89% flex w-full items-start justify-start gap-3 bg-gradient-to-b from-[#3C5778] from-0% to-[#567CAB] p-8 lg:px-16">
